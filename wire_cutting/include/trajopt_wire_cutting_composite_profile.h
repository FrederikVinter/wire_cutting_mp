/**
 * @file trajopt_wire_cutting_composite_profile.h
 * @brief
 *
...
{
public:
  using Ptr = std::shared_ptr<TrajOptWireCuttingCompositeProfile>;
  using ConstPtr = std::shared_ptr<const TrajOptWireCuttingCompositeProfile>;

  TrajOptWireCuttingCompositeProfile() = default;
  ~TrajOptWireCuttingCompositeProfile() override = default;
  TrajOptWireCuttingCompositeProfile(const tinyxml2::XMLElement& xml_element);
  TrajOptWireCuttingCompositeProfile(const TrajOptWireCuttingCompositeProfile&) = default;
  TrajOptWireCuttingCompositeProfile& operator=(const TrajOptWireCuttingCompositeProfile&) = default;
  TrajOptWireCuttingCompositeProfile(TrajOptWireCuttingCompositeProfile&&) = default;
  TrajOptWireCuttingCompositeProfile& operator=(TrajOptWireCuttingCompositeProfile&&) = default;
